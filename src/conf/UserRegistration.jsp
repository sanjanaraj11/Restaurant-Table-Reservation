...
<body  style="backgound: url('../Images/background2.jpg') fixed;background-position:centre;border:10;">
    ...
    <form name="registration">  
        ...
        <table cellspacing='.2' cellpadding='.2' border='.5' bordercolor="brown">
            <p><font color="white" size="3" ><b><i>*we look forward to serving our customers better and faster by<br> facilitating you to reserve a table based on your need !!!</b></i></font></p>
